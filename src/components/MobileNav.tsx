                    ...
                    <div className="p-3">
                        {showAccountInfo ? (
                            <div className="flex justify-between items-center gap-[11px]">
                                ...
                                {!isWalletLoading && (
                                    <button className="bg-transparent border-0 p-0 cursor-pointer flex items-center justify-center" onClick={handleLogout} aria-label="Logout">
                            ...
                            <div className="w-full">
                                {isWalletLoading ? (
                                    <div className="w-full text-center text-[#9B9797] py-2">Checking wallet…</div>
                                ) : (
                                    <button className="w-full px-3 py-2 bg-white/10 rounded-md hover:bg-white/20 transition" onClick={() => openConnectModal && openConnectModal()}>
                                        Connect Wallet
                                    </button>
                                )}
                            </div>
