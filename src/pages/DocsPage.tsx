...
import { ENDPOINTS as DOCS_ENDPOINTS, EXAMPLES as DOCS_EXAMPLES } from '../constants/docsConstants';
...
// Endpoint mapping moved to constants
...
const DocsPage = React.memo(() => {
  ...
  const handleLogout = () => { logoutUser(); try { disconnect(); } catch { } setMobileMenuOpen(false); };
  ...
  return (
    <>
      {/* Mobile nav handled by AppLayout */}
      {false && (<>
        {/* Mobile Header */}
                    ...
                    <div className="mobile-user-profile">
                      <div className="mobile-user-info">
                        ...
                        {isConnected && user ? (
                          ...
                          <span className="mobile-username">Connect wallet</span>
                        )}
                      </div>
      ...
      <div className="docs-page-container page-wrap">
        {/* Header Section */}
        ...
        {categories.map((cat) => {
          ...
          const endpoint = DOCS_ENDPOINTS[cat] || API_ENDPOINTS.COMPLETIONS;
